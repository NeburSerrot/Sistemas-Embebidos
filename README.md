...
* Raspberry Pi con Raspberry Pi OS instalado y configurado.
* Paquetes necesarios: `mosquitto`, `mosquitto-clients`, `node-red`.

### 2. Configuración del Broker (Mosquitto)
Editar el archivo de configuración para habilitar WebSockets y acceso externo:
